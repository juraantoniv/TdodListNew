...
const instance = axios.create({
    ...
    headers: {
        'API-KEY': '9b178376-82ad-41ed-acf3-77c892b9b592'
    }
})
...
export const todolistsAPI = {
    ...
    createTask(todolistId: string, title: string) {
        return instance.post<ResponseType<{ item: TaskType }>, AxiosResponse<ResponseType<{ item: TaskDomainType }>>, { title: string }>(`todo-lists/${todolistId}/tasks`, {title});
    },
